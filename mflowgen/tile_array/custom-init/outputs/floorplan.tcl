...
set grid_margin_t [expr 31 ]
set grid_margin_b [expr 31 ]
set grid_margin_l [expr 51 ]
set grid_margin_r [expr 51 ]
...
set core_margin_t [expr 11.98]
set core_margin_b [expr 11.98]
set core_margin_r [expr 11.98]
set core_margin_l [expr 11.98]
...
#floorPlan -s [expr 2910 - $core_margin_l - $core_margin_r] \
#             [expr 3510 - $core_margin_b - $core_margin_t] \
#             $core_margin_l $core_margin_b $core_margin_r $core_margin_t
...
for {set row $min_row} {$row <= $max_row} {incr row} {
  for {set col $min_col} {$col <= $max_col} {incr col} {
    ...
    for {set index 0} {$index < $num_id_pins} {incr index} {
      ...
      set tie_pin [get_pins -of_objects $id_net -filter "name!~*id*"] 
...
# createRouteBlk -name tile_route_blk -layer {li1 met1 met2 met3 met4 met5} -box {18 47.5 2892 3462.6}
#selectInst Interconnect_inst0_Tile_X00_Y08
#set array_llx [dbGet selected.box_llx]
#set array_lly [dbGet selected.box_lly]
#deselectAll
#
#selectInst Interconnect_inst0_Tile_X03_Y01
#set array_urx [dbGet selected.box_urx]
#set array_ury [dbGet selected.box_ury]
#deselectAll
#
#set hori_margin 1.7
#set vert_margin 1.7
#
#set array_rbox_llx [expr $array_llx + $hori_margin]
#set array_rbox_lly [expr $array_lly + $vert_margin]
#set array_rbox_urx [expr $array_urx - $hori_margin]
#set array_rbox_ury [expr $array_ury - $vert_margin]
#set array_rbox "$array_rbox_llx $array_rbox_lly $array_rbox_urx $array_rbox_ury"
#
#createRouteBlk -name array_route_blockage -layer {li1 met1 met2 met3 met4 met5} -box $array_rbox
