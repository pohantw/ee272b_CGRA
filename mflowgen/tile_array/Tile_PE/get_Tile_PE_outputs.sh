...
#cp -L $build_path/*synopsys-ptpx-genlibdb/outputs/design.lib          outputs/Tile_PE_tt.lib
#cp -L $build_path/*synopsys-ptpx-genlibdb/outputs/design.db           outputs/Tile_PE_tt.db
