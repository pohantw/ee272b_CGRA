...
set ofst_t [expr $macro_ring_spacing+16.56] 
set ofst_b [expr $macro_ring_spacing+14.42]
set ofst_l [expr $macro_ring_spacing+9.76]
set ofst_r [expr $macro_ring_spacing+1.9]

deselectAll
selectInst MemCore_inst0/LakeTop_W_inst0/LakeTop_memory_0
...
deselectAll
selectInst MemCore_inst0/LakeTop_W_inst0/LakeTop_memory_0
sroute -connect {blockPin} -layerChangeRange {met1 met5} -blockPinTarget { nearestTarget } -nets {VDD VSS} -allowLayerChange 1 -blockPin useLef -inst MemCore_inst0/LakeTop_W_inst0/LakeTop_memory_0
